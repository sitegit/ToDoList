# Приложение To Do List (Тестовое Задание для участия в стажировке компании SimbirSoft)
Приложение представляет из себя простой планировщик задач.

## Особенности Тестового Задания
- Реализация функциональности согласно предоставленным требованиям.
- Просмотр списка задач с возможностью выбора дня.
- Просмотр детальной информации о задаче.
- Добавление новой задачи.
- Реализовано сохранение в базе данных.
